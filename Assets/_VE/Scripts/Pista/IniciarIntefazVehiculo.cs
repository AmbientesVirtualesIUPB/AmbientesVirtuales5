...
public class IniciarIntefazVehiculo : MonoBehaviour
{
    ...
    public void InicializarComponentesInterfaz(GameObject obj)
    {
    ...
    public void InteractuarInterfaz()
    {
        ...
        {
            if (debugEnConsola) print("falta inicializar componentes en el script IniciarInterfazVehiculo");
        }
        else
        {   
    ...
    IEnumerator CargarBateria()
    {
        ...
        for (int i = 3; i < imagenes.Length; i++)
        {
    ...
    {
        //carrera.Iniciar(); // Accion temporal momentanea para iniciar la carrera
