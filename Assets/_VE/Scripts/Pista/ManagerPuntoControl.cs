...
public class ManagerPuntoControl : MonoBehaviour
{
    ...
    /// </summary>
    /// <param name="punto"> Vector 3 recibido desde el script de conducir, tanto posicion como rotacion </param>
    /// <returns></returns>
    public Transform ObtenerPuntoCercano(Vector3 punto)
    {
        ...
        for (int i = 0; i < controls.Count; i++)
        {
            ...
            if (d < distancia)
            {
                ...
                min = controls[i].transform; // Asignamos el punto mas cercano
            }
        }
