...
public class RotarVolante : MonoBehaviour
{
    ...
    void Start()
    {
        // Guardar el ángulo inicial - eulerAngles para obtener o establecer la rotación de un objeto en términos de ángulos de Euler
        anguloInicial = pivote.localRotation.eulerAngles.y;
    }
    ...
    void Update()
    {
        if (pivote != null)
        {
            ...
            // Aplicar la rotación al pivote en el eje Y = Up
            pivote.Rotate(Vector3.up, nuevoAngulo - anguloActual);
            ...
            if (!Input.GetKey(KeyCode.A) && !Input.GetKey(KeyCode.D))
            {
                ...
                pivote.Rotate(Vector3.up, anguloActual - pivote.localRotation.eulerAngles.y);
            }
        }
    }
}
